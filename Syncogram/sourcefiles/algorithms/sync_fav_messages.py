...
@logger.catch()
async def sync_favorite_messages(ui: Task):
    """
    ...
    ui.unsuccess("asdasd")
    print("работает")
    # sender: TelegramBaseClient = UserClient(self.database.get_session_by_status(1))
    # recepient: TelegramBaseClient = UserClient(self.database.get_session_by_status(0))
